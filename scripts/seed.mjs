...
const leads = [
  { id: genId('ld'), name: 'Usman Farooq', phone: '0301 2345678', source: 'WhatsApp', campaign: '', destination: 'UK', visaType: 'Tourist', stage: 'New', assignedTo: t2, createdAt: today(), notes: '', messages: [], nextFollowUp: today(), lastContacted: '', escalated: false, escalationReason: '', escalationResolved: false, lostReason: '' },
  { id: genId('ld'), name: 'Mehwish Ali', phone: '0333 1122334', source: 'Website', campaign: '', destination: 'Schengen', visaType: 'Tourist', stage: 'Contacted', assignedTo: t1, createdAt: today(), notes: '', messages: [], nextFollowUp: '2026-01-01', lastContacted: '2025-12-20', escalated: false, escalationReason: '', escalationResolved: false, lostReason: '' },
  { id: genId('ld'), name: 'Hamid Sheikh', phone: '0345 7788990', source: 'Facebook', campaign: '', destination: 'Canada', visaType: 'Business', stage: 'Qualified', assignedTo: t3, createdAt: today(), notes: '', messages: [], nextFollowUp: today(), lastContacted: '', escalated: false, escalationReason: '', escalationResolved: false, lostReason: '' },
];
